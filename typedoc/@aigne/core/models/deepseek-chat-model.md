...
| <a id="supportsnativestructuredoutputs"></a> `supportsNativeStructuredOutputs` | `boolean` | `false`              | [`OpenAIChatModel`](openai-chat-model.md#openaichatmodel).[`supportsNativeStructuredOutputs`](openai-chat-model.md#openaichatmodel#supportsnativestructuredoutputs-1) |
| <a id="supportstoolsemptyparameters"></a> `supportsToolsEmptyParameters`       | `boolean` | `false`              | [`OpenAIChatModel`](openai-chat-model.md#openaichatmodel).[`supportsToolsEmptyParameters`](openai-chat-model.md#openaichatmodel#supportstoolsemptyparameters-1)       |
