...
`,
    ...
    v0: {
      ...
      cannotSetPropertiesTip:
        "Failed to parse PROPERTIES_SCHEMA, this code cannot be set properties",
      codePreview: "Code Preview",
      codePreviewTip:
        "Here is the code preview, you can view the generated code, and editing is not supported yet.",
