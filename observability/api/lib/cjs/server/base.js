...
const expressMiddlewareSchema = zod_1.z
    .function()
    .args(zod_1.z.custom(), zod_1.z.custom(), zod_1.z.custom())
...
async function startServer(options) {
    ...
    app.use("/api/trace", (0, trace_js_1.default)({ sse, middleware: Array.isArray(middleware) ? middleware : [middleware] }));
    app.use("/api/settings", (0, settings_js_1.default)({ middleware: Array.isArray(middleware) ? middleware : [middleware] }));
