...
## [1.10.0](https://github.com/AIGNE-io/aigne-framework/compare/example-workflow-orchestrator-v1.9.2...example-workflow-orchestrator-v1.10.0) (2025-05-16)
...
* The following workspace dependencies were updated
  * dependencies
    * @aigne/agent-library bumped to 1.8.2
