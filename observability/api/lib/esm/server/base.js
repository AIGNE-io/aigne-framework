...
export async function startServer(options) {
    ...
    app.use("/api/trace", traceRouter({ sse, middleware: Array.isArray(middleware) ? middleware : [middleware] }));
    app.use("/api/settings", settingsRouter({ middleware: Array.isArray(middleware) ? middleware : [middleware] }));
