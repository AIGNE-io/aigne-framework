...
- [`BedrockChatModel`](bedrock-chat-model.md#bedrockchatmodel)
...
| Parameter | Type                                | Description                                                  |
| --------- | ----------------------------------- | ------------------------------------------------------------ |
| `input`   | [`ChatModelInput`](#chatmodelinput) | The standardized input containing messages and model options |
| `context` | `Context`                           | The execution context with settings and state                |
