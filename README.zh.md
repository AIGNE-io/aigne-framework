...
* [examples](https://github.com/AIGNE-io/aigne-framework/tree/main/examples) - 示例项目，演示如何使用不同的代理处理各种任务。
...
* [MCP Server](https://github.com/AIGNE-io/aigne-framework/tree/main/examples/mcp-server) - 使用 AIGNE CLI 构建 MCP 服务器，对外提供 MCP 服务。
* [Puppeteer MCP Server](https://github.com/AIGNE-io/aigne-framework/tree/main/examples/mcp-puppeteer) - 学习如何通过 AIGNE Framework 利用 Puppeteer 进行自动化网页抓取。
* [SQLite MCP Server](https://github.com/AIGNE-io/aigne-framework/tree/main/examples/mcp-sqlite) - 探索通过模型上下文协议连接 SQLite 进行数据库操作。
* [Github](https://github.com/AIGNE-io/aigne-framework/tree/main/examples/mcp-github) - 了解如何使用 AIGNE Framework 和 GitHub MCP 服务器与 GitHub 仓库进行交互。

### 工作流模式

* [Workflow Router](https://github.com/AIGNE-io/aigne-framework/tree/main/examples/workflow-router) - 实现智能路由逻辑，根据内容将请求定向到适当的处理程序。
* [Workflow Sequential](https://github.com/AIGNE-io/aigne-framework/tree/main/examples/workflow-sequential) - 构建具有保证执行顺序的步骤式处理管道。
* [Workflow Concurrency](https://github.com/AIGNE-io/aigne-framework/tree/main/examples/workflow-concurrency) - 通过并行执行同时处理多个任务优化性能。
* [Workflow Handoff](https://github.com/AIGNE-io/aigne-framework/tree/main/examples/workflow-handoff) - 在专业代理之间创建无缝转换以解决复杂问题。
* [Workflow Reflection](https://github.com/AIGNE-io/aigne-framework/tree/main/examples/workflow-reflection) - 通过输出评估和修正能力实现自我提升。
* [Workflow Orchestration](https://github.com/AIGNE-io/aigne-framework/tree/main/examples/workflow-orchestration) - 协调多个代理在复杂处理管道中共同工作。
* [Workflow Code Execution](https://github.com/AIGNE-io/aigne-framework/tree/main/examples/workflow-code-execution) - 在 AI 驱动的工作流中安全执行动态生成的代码。
* [Workflow Group Chat](https://github.com/AIGNE-io/aigne-framework/tree/main/examples/workflow-group-chat) - 通过聊天模型实现群聊功能，支持多个用户同时参与。
