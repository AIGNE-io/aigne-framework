[Documentation](../../README.md) / [@aigne/core](README.md) / client
...
> **new AIGNEClient**(`options`): [`AIGNEClient`](#aigneclient)
...
[`AIGNEClient`](#aigneclient)

#### Properties

##### options

> **options**: [`AIGNEClientOptions`](#aigneclientoptions)
...
| `input`    | `I`                                                                                    | Input message for the agent                                    |
| `options?` | [`AIGNEClientInvokeOptions`](#aigneclientinvokeoptions) & \{ `streaming?`: `false`; \} | Options with streaming mode explicitly set to false or omitted |
...
| `agent`   | `string`                                                                             | Name of the agent to invoke                        |
| `input`   | `I`                                                                                  | Input message for the agent                        |
| `options` | [`AIGNEClientInvokeOptions`](#aigneclientinvokeoptions) & \{ `streaming`: `true`; \} | Options with streaming mode explicitly set to true |
...
| `agent`    | `string`                                                | Name of the agent to invoke |
| `input`    | `I`                                                     | Input message for the agent |
| `options?` | [`AIGNEClientInvokeOptions`](#aigneclientinvokeoptions) | Options for the invocation  |
