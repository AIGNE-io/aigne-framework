...
import addComponentIdColumn from "./migrations/002-add-componentId.js";
import addActionColumn from "./migrations/003-add-action.js";

export async function migrate(db: LibSQLDatabase | SqliteRemoteDatabase) {
  const migrations = [init, addComponentIdColumn, addActionColumn];
