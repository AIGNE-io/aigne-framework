...
## [1.17.6](https://github.com/AIGNE-io/aigne-framework/compare/example-workflow-code-execution-v1.17.5...example-workflow-code-execution-v1.17.6) (2025-07-25)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @aigne/cli bumped to 1.25.2
    * @aigne/core bumped to 1.38.2
