...
[@aigne/core](../../README.md) / core/models/OpenRouterChatModel

# core/models/OpenRouterChatModel
...
| ------------------------------------------------------------------ | --------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="apikeyenvname"></a> `apiKeyEnvName`                         | `string`  | `"OPEN_ROUTER_API_KEY"` | -                                                                                                                                                     | [`OpenAIChatModel`](OpenaiChatModel.md#openaichatmodel).[`apiKeyEnvName`](OpenaiChatModel.md#openaichatmodel#apikeyenvname)                           |
