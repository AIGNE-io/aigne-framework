...
[English](_media/README.md) | [中文](_media/README.zh.md)
...
- [CLI Guide](_media/cli.md) ([中文](_media/cli.zh.md)): Comprehensive guide to the AIGNE CLI tool
- [Agent Development Guide](_media/agent-development.md) ([中文](_media/agent-development.zh.md)): Guide to developing AIGNE agents using YAML/JS configuration files
- [Cookbook](_media/cookbook.md) ([中文](_media/cookbook.zh.md)): Practical recipes and patterns for AIGNE Framework API usage
- API References:
  - [Agent API](_media/agent-api.md) ([English](_media/agent-api.md) | [中文](_media/agent-api.zh.md))
  - [AI Agent API](_media/ai-agent-api.md) ([English](_media/ai-agent-api.md) | [中文](_media/ai-agent-api.zh.md))
  - [Function Agent API](_media/function-agent-api.md) ([English](_media/function-agent-api.md) | [中文](_media/function-agent-api.zh.md))
  - [MCP Agent API](_media/mcp-agent-api.md) ([English](_media/mcp-agent-api.md) | [中文](_media/mcp-agent-api.zh.md))
  - [AIGNE API](_media/aigne-api.md) ([English](_media/aigne-api.md) | [中文](_media/aigne-api.zh.md))
  - [Server/Client API](_media/server-client-api.md) ([English](_media/server-client-api.md) | [中文](_media/server-client-api.zh.md))
...
- Contributing Guidelines: See [CONTRIBUTING.md](_media/CONTRIBUTING.md)
- Release Process: See [RELEASING.md](_media/RELEASING.md)

## License

This project is licensed under the [Elastic-2.0](_media/LICENSE) - see the [LICENSE](_media/LICENSE) file for details.
